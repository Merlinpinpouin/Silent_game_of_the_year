...
while continuer:
    ...
    #inventaire du haut
    inventaire1=pygame.image.load(d.image_inventaire_1()).convert_alpha()
    image_inve_redim1 = pygame.transform.scale(inventaire1, (170, 170))
    fenetre.blit(image_inve_redim1,(45,105))
    #inventaire du bas
    inventaire2=pygame.image.load(d.image_inventaire_2()).convert_alpha()
    image_inve_redim2 = pygame.transform.scale(inventaire2, (170, 170))
    fenetre.blit(image_inve_redim2,(45,305))
    clock.tick(FPS)  
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            #le bas
            if pygame.mouse.get_pos()[0] > 10 and pygame.mouse.get_pos()[0] < 250 \
            and pygame.mouse.get_pos()[1] > y-262 and pygame.mouse.get_pos()[1] < y-262+252 and compteur==3:
                d.mettre_dans_inventaire2(v.read_weapon_from_csv())

            #le haut
            if pygame.mouse.get_pos()[0] > 10 and pygame.mouse.get_pos()[0] < 250 \
            and pygame.mouse.get_pos()[1] > y-262*2 and pygame.mouse.get_pos()[1] < y-262*2+252 and compteur==4:
                d.mettre_dans_inventaire1(v.read_food_from_csv())
